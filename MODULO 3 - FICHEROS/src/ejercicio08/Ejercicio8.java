...
/*	Ejercicio Nro 8
	...
	sus líneas ordenadas alfabéticamente (no distinguir minúsculas de mayúsculas a la
	hora de ordenar).*/
...
class ficheros {
    ...
    public static void cargarCodigo(String nombre){
    ...
    public static void main(String[] args) throws Exception {
        cargarCodigo("./src/resources/ordena.txt");
